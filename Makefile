...
docc: requirejq
	...
	generate-documentation \
 	...
 	--hosting-base-path ${TARGET_NAME_LOWERCASE} \
	--emit-digest
	...
	@echo "Check https://janodev.github.io/${TARGET_NAME_LOWERCASE}/documentation/${TARGET_NAME_LOWERCASE}/"
	@echo ""
...
doccapp: requirejq
	...
	xcodebuild docbuild \
		...
		OTHER_DOCC_FLAGS="--transform-for-static-hosting --hosting-base-path ${TARGET_NAME_LOWERCASE} --output-path docs"
	@echo "Check https://janodev.github.io/${TARGET_NAME_LOWERCASE}/documentation/${TARGET_NAME_LOWERCASE}/"
	@echo ""
